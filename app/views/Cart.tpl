        ...
        <section class="container py-5">
            <div class="row w-100">
                ...
                <div class="row">
                    <div class="col">
                        <ul class="list-group">
                            {foreach $partObjArray as $part}
                                {include file="`$smarty.current_dir`\\templates\Cart_element.tpl" part=$part}
                            {/foreach}
                        </ul>
                    </div>
                </div>
            ...
            <div class="row mt-4 justify-content-end">
                <form id="sendOrder" method="post" action="{$conf->app_root}/createOrder"></form>
                <hr>
                <div class="col">
                ...
                <div class="col d-flex justify-content-end">
                    ...
                    <span class="me-5 fw-bold">{math equation=$sumOfProducts/100 format="%.2f"} zł</span>
                </div>
            </div>
            <div class="row">
                <div class="col d-flex justify-content-end">
